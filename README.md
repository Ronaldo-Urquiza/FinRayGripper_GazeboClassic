...
Mais detalhes sobre cada um desses pontos — incluindo a lógica de detecção de contato e o diagrama de estados do nó de movimentação — estão no manual em PDF.
